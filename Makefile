...
all: search dump-word corpus-test dedigitize digitize invert lemmatize make-aliases make-artitles make-binmorfo make-corpus make-index make-mosquare 
...
make-artitles: make-artitles.o common.o
...
clean:
	rm -f *.o search dump-word mark-stop corpus-test dedigitize digitize invert lemmatize make-aliases make-artitles make-binmorfo make-corpus make-index make-mosquare
